                    	...
                    	<div id="goodPanel">
	                        <div class="panel-body row">
	                            ...
	                            <div class="form-group col-md-1 amountDiv">
	                                    ...
	                                    <!-- <span class="amount" style="margin-top:30px;"></span> -->
	                            </div>
                            </div>
                     	</div>
                     	<!-- 重复结束 -->
                    	...
                    	<div class="panel-body">
                    		<div class="row">
                    			...
                    			<div class="container" style="margin-top:10px;">
                    				...
                    				<div class="row">
                    					<div class="row col-xs-4 title"><label>货品规格</label></div>
                    					<div class="col-xs-8 goodsSpecificationDiv_xs">
			                                <select style="font-size:10px;height:20px;width:100%;textalign:center;" class="selectGoodsSpecification_xs">
			                                	<option value="" selected="selected">请选择货品规格</option>
			                                </select>
			                                <input class="goodsid_xs" type="hidden">
			                            </div>
                    				...
                    				<div class="row">
                    				<div class="row col-xs-4 title"><label>货品颜色</label></div>
                    					<div class="form-group col-xs-8 goodsColorDiv_xs">
			                                <select style="font-size:10px;height:20px;width:100%;textalign:center;" class="selectGoodsColor_xs">
			                                	<option value="" selected="selected">请选择货品颜色</option>
			                                </select>
			                                <input class="goodsid_xs" type="hidden">
			                            </div>
                    		...
                    		<div class="row">
                    			<div class="col-xs-6">
                    				<div class="row">
                    					<div class="col-xs-6"><label class="title">库存（件）：</label></div>
			                    		<div><input type="text" class="onhand_xs" readonly="readonly" style="border:none;background:none;height:20px;width:60px;font-size:10px"></div>
                    				</div>
			                    </div>
			                    <div class=" col-xs-6">
			                    	<div class="row">
                    					<div class="col-xs-6"><label class="title">单价（元）：</label></div>
			                    		<div><input type="text" class="price_xs" readonly="readonly" style="border:none;background:none;height:20px;width:60px;font-size:10px"></div>
                    				</div>
			                    </div>
			                    <div class=" col-xs-6">
			                    	<div class="row">
...
<script type="text/javascript">
	 ...
	 $('.selectGoodsName_xs').change(function(){
		 var select = $(this);
		 var name = $(this).find('option:selected').text();
		 var selectSpecification = select.parents('.panel-body').find('.goodsSpecificationDiv_xs');
		 var selectColor = select.parents('.panel-body').find('.goodsColorDiv_xs');
		 var select1 = selectSpecification.find('.selectGoodsSpecification_xs');
		 var select2 = selectColor.find('.selectGoodsColor_xs');
		 select1.empty();
		 select2.empty();
		 select1.append("<option value='' selected='selected'>请选择货品规格</option>");
		 select2.append("<option value='' selected='selected'>请选择货品颜色</option>");
	 ...
	 $('.selectGoodsSpecification_xs').change(function(){
		 var select = $(this);
		 var name = $(this).parents('.panel-body').find('.goodsNameDiv_xs').find('.selectGoodsName_xs').find('option:selected').text();
		 var specification = select.find('option:selected').text();
		 var selectColor = select.parents('.panel-body').find('.goodsColorDiv_xs');
		 var select1 = selectColor.find('.selectGoodsColor_xs');
		 select1.empty();
		 select1.append("<option value='' selected='selected'>请选择货品颜色</option>");
		 $.ajax({
			 url: 'getColors',
	 ...
	 $('.selectGoodsColor').change(function(){
		 ...
		 $.ajax({
			 ...
			 success: function(data){
				...
				select.parents('.panel-body').find('.goodsImageDiv').find('.goodsImg').attr('src', data.imagePath);
			 },
			 error: function(data, status, e){
				 alert("发生未知错误");
			 }
	 ...
	 $('.selectGoodsColor_xs').change(function(){
		 var name = $(this).parents('.panel-body').find('.goodsNameDiv_xs').find('.selectGoodsName_xs').find('option:selected').text();
		 var specification = $(this).parents('.panel-body').find('.goodsSpecificationDiv_xs').find('.selectGoodsSpecification_xs').find('option:selected').text();
		 var color = $(this).find('option:selected').text();
		 var select = $(this);
		 var level = $('#level_xs').val();
		 $.ajax({
			 url: 'getDetailGoodsInfo',
			 data: {'name':name, 'specification':specification, 'color':color, 'level':level},
			 dataType: 'json',
			 ...
			 success: function(data){
				...
				select.parents('.panel-body').find('.goodsImageDiv_xs').find('.goodsImg_xs').attr('src', data.imagePath);
			 },
			 error: function(data, status, e){
				 alert("发生未知错误");
			 }
	...
	$('#uploadInfoBtn_xs').click(function(){
		$('#uploadInfoBtn_xs').attr('disabled', 'disabled');
